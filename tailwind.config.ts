  ...
  theme: {
    ...
    extend: {
      ...
      boxShadow: {
        ...
        lift: "0 24px 80px -40px hsl(var(--foreground) / 0.22)",
        glow: "0 0 0 1px hsl(var(--border)), 0 16px 60px -44px hsl(var(--foreground) / 0.28)",
      },
      keyframes: {
        "accordion-down": {
          from: {
      ...
      animation: {
        ...
        "enter": "fade-in 0.6s ease-out, scale-in 0.45s ease-out",
